...
public class CreateSprintController {
    /**
     * The CreateSprintController class serves as an intermediary between the user interface
     * (UI) and the business logic of creation of sprints.
     * This controller handles the use case specified in the US019 where it is requested to create a sprint.
     */
    @Autowired
