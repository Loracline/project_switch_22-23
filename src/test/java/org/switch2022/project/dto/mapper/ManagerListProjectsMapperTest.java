...
public class ManagerListProjectsMapperTest {
    ...
    @BeforeEach    void setUp() {
        ...
        projectOneDTO = new ProjectDto("AA001", "Aptoide", "ISEP", "Planned", "Fixed cost",
                "fishing");
        projectTwoDTO = new ProjectDto("AA004", "Aptoide", "PortoTech", "Planned", "Fixed cost",
                "Hunting");
        projectThreeDTO = new ProjectDto("AA001", "Aptoide", "ISEP", "Planned", "Fixed cost",
                "fishing");
    ...
    @Test    void getListOfProjectsDTO() {
        ...
        expected.add(new ProjectDto("AA001", "Aptoide", "isep", "planned",
                "fixed cost", "fishing"));
