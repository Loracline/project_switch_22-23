...
class TypologyJpaTest {
     ...
     */
    @DisplayName("Equals test for TypologyId: typology equals itself")
    @Test
     ...
     */
    @DisplayName("Equals test for TypologyId: two typologies are the same")
    @Test
     ...
     * false.
     */
    @DisplayName("Equals test for TypologyId: not equals another object")
     ...
     */
    @DisplayName("Equals test for TypologyId: not null")
    @Test
     ...
     */
    @DisplayName("Equals test for TypologyId: same id")
    @Test
     ...
     */
    @DisplayName("Hashcode test for TypologyId")
    @Test
