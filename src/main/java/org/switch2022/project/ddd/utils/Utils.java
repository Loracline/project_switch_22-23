...
public final class Utils {
    ...
    public static int getIntFromAlphanumericString(String initialExpression,
        ...
        String[] array = initialExpression.toLowerCase().split(expressionToRemove.toLowerCase(),
                SPLIT_LIMIT);
     ...
     */
    public static boolean hasStatus(ProjectStatus actualProjectStatus,
                                    ProjectStatus desiredProjectStatus) {
